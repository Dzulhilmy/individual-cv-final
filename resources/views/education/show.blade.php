...
text-gray-900">
                        ...
                        <input type="text" id="title" name="title" value="{{ $education->title }}" readonly
...
medium text-gray-900">
                        ...
                        <textarea id="description" name="description" rows="4" readonly
                            class="bg-gray-100 border border-gray-300 text-gray-
900 text-sm rounded-lg block w-full p-2.5 cursor-not-allowed">{{ $education->description }}</textarea>
                    </div>
