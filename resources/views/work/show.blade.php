    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Show Work & Related Experience') }}
            </h2>
...
text-gray-900">
                        ...
                        <input type="text" id="title" name="title" value="{{ $work->title }}" readonly
...
medium text-gray-900">
                        ...
                        <textarea id="description" name="description" rows="4" readonly
                            class="bg-gray-100 border border-gray-300 text-gray-
900 text-sm rounded-lg block w-full p-2.5 cursor-not-allowed">{{ $work->description }}</textarea>
                    </div>
                    <div class="mb-6">
